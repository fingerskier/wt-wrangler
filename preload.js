...
contextBridge.exposeInMainWorld('wt', {
  ...
  listStaleBackups: () => ipcRenderer.invoke('wt:listStaleBackups'),
  restoreBackup: backupPath => ipcRenderer.invoke('wt:restoreBackup', backupPath),
  discardBackups: () => ipcRenderer.invoke('wt:discardBackups'),
